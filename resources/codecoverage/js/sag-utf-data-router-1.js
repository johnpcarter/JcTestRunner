    ...
    app.controller('treeTable-datarouter', [
        ...
        function (
            ...
            var packagesummary = function () {
                ...
                overallsummary.overall_pkg_coveragepercent = parseFloat((pkgs_instruction.visitedChildCount * 100 ) / pkgs_instruction.childCount);
                ...
                overallsummary.overall_pkg_childcount_cs = CommaFormatted(pkgs_instruction.childCount);
                overallsummary.overall_pkg_visitedchildcount = pkgs_instruction.visitedChildCount;
                overallsummary.overall_pkg_visitedchildcount_cs = CommaFormatted(pkgs_instruction.visitedChildCount);
            ...
            var testsummary = function () {
                ...
                overallsummary.overall_tst_childcount = testDescriptionsResult.totalchildcount;
                overallsummary.overall_tst_childcount_cs = CommaFormatted(overallsummary.overall_tst_childcount);
                overallsummary.overall_tst_visitedchildcount = testDescriptionsResult.totalvisitedchildcount;
